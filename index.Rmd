...
.center[**Compartiendo** con otros]

<br><br>
.center[Un archivo `my_package.tar.gz`] 

--

<br>

.center[Crear con `R CMD build my_package`]
...
## Eligiendo el repositorio adecuado

<br><br>

- Repositorio

.center[Repositorio git, svn, or ninguno]
...
.center[CRAN, Bioconductor, rOpenSci, rOpenSpain, Zenodo]
...
.center[GitHub + R-universe + (rOpenSci o rOpenSpain) + CRAN/Bioconductor + Zenodo]
...
- Compartir algo de calidad que pueda ser útil para otros.
- Hacer fácil que otros dependan de tu paquete.
- Otros: trabajo, beca, prestigio...
...
.bottom[.center[Elige el que sea mejor para ti y tus usuarios]]
...
.center[.middle[Diferente configuración y diferente revisión.]]
...
.center[
Datos de CRAN gracias al [incoming dashboard](https://lockedata.github.io/cransays/articles/dashboard.html).
...
.center[
Los revisores mueven los paquetes [entre carpetas](https://llrs.dev/2021/01/cran-review/#cran-load).
]
...
.center[
Comprueba [el panel](https://lockedata.github.io/cransays/articles/dashboard.html) antes de enviar el paquete.
]
...
.center[Las revisiones son cortas, y breves.]
